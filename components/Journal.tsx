	...
	return (
		<>
			<div
				...
				className={`fixed top-0 left-0 w-full h-screen z-60
			...
			<AnimatePresence>
				{!isOpen && (
					<motion.img
						...
						className="w-[10vw] fixed bottom-[2vh] right-[2vh] cursor-pointer z-50"
					/>
				)}
			</AnimatePresence>
					...
					<AnimatePresence mode="wait">
						{page == 1 && (
							<motion.div
								...
								className="fixed top-[10vh] left-1/2 -translate-x-1/2 w-[70vw] drop-shadow-2xl overflow-hidden"
							>
								<img
									rel="preload"
								...
								<img
									...
									className="w-[26vw] absolute h-[80vh] top-0 left-0 z-1"
									alt=""
								/>
								<p
								...
								<img
									...
									onClick={() =>
										setSelectedItem(
											selectedItem == "picture" ? null : "picture"
										)
									}
								...
								<img
									...
									className="w-[16.9vw] absolute h-[80vh] top-0 left-0 z-5"
									alt=""
								/>
								<img
									rel="preload"
									src="/imgs/pocket-1.png"
									className="w-[8vw] absolute h-[80vh] top-0 left-0 z-9"
									alt=""
								/>
								<AnimatePresence mode="wait">
									{!isFading && (
										...
										>
											...
											>
												...
												<div className="flex gap-[1vw] mt-[1.5vh]">
													...
													>
														Today, I'm starting a new life, the life where I can
														be myself, the life where I can be free.
													</motion.p>
												</div>
												<motion.p
													variants={item}
						...
						{page == 2 && (
							<div className="fixed top-[10vh] left-1/2 -translate-x-1/2 w-[70vw] drop-shadow-2xl drop-shadow-black/0">
								<img
									rel="preload"
						...
						{page == 3 && (
							<motion.div
								...
								exit={{ opacity: 0, y: -20 }}
								transition={{ duration: 0.35, ease: "easeInOut" }}
								className="fixed top-[10vh] left-1/2 -translate-x-1/2 w-[70vw] drop-shadow-2xl drop-shadow-black/0"
							>
								<img
									rel="preload"
								...
								<img
									...
									className="w-[27vw] h-[80vh] absolute top-0 right-0"
									alt=""
								/>
								<AnimatePresence mode="wait">
									{!isFading && (
										...
										>
											...
											<p className="text-[2.75vh] hand-coffe mt-[3.5vh]">
												Lorem, ipsum dolor sit amet consectetur adipisicing
												elit. Provident, obcaecati. Lorem ipsum dolor sit amet
